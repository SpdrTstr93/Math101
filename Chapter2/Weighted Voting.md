A **weighted voting system** is any voting system where the voters do not have equal say in an election. In this section only we will consider voting systems that only have *yes-no* votes, known as **motions**.
